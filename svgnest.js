...
(function(root){
	...
	function SvgNest(){
		...
		this.start = function(progressCallback, displayCallback){						
			...
			//binPolygon[0].x = 0;
			//binPolygon[0].y = 0;
			//binPolygon[1].x = 511.822;
			//binPolygon[1].y = 0;
			//binPolygon[2].x = 511.822;
			//binPolygon[2].y = 339.235;
			//binPolygon[3].x = 0;
			//binPolygon[3].y = 339.235;
			//binPolygon.width = 511.822;
			//binPolygon.height = 339.235;
			...
			p.map(function(pair){
				...
				p2.map(worker.placePaths).then(function(placements){
					...
					if(!best || bestresult.fitness < best.fitness){
						...
						for(var j=0; j<best.placements[0].length; j++)
						{
							if(best.placements[0][j].id == 0)
							{
								best.placements[0][j].x = 214;
								best.placements[0][j].y = 385;
								best.placements[0][j].rotation = 0;

								


							}
							else if(best.placements[0][j].id == 1)
							{
								

								best.placements[0][j].x = 706;
								best.placements[0][j].y = 1080;
								best.placements[0][j].rotation = -180;	


							}
							else if(best.placements[0][j].id == 2)
							{
								//best.placements[0][j].x = -700.092;
								//best.placements[0][j].y = -419.598;
								//best.placements[0][j].rotation = 0;
								
								//best.placements[0][j].x = -709.718;
								//best.placements[0][j].y = -404.964;
								//best.placements[0][j].rotation = 0;
																
								//best.placements[0][j].x = 726.809;
								//best.placements[0][j].y = 472.984;
								//best.placements[0][j].rotation = 180;

								//best.placements[0][j].x = 464.014;
								//best.placements[0][j].y = -693.168;
								//best.placements[0][j].rotation = 90;

								//best.placements[0][j].x = 1146.79;
								//best.placements[0][j].y = 1042.37;
								//best.placements[0][j].rotation = 180;
								...
								//best.placements[0][j].x = 500;
								//best.placements[0][j].y = 500;
								//best.placements[0][j].rotation = 180;
							...
							else if(best.placements[0][j].id == 3)
							{
								//best.placements[0][j].x = -434.054;
								//best.placements[0][j].y = 641.687;
								//best.placements[0][j].rotation = 270;
								
								//best.placements[0][j].x = 476.237;
								//best.placements[0][j].y = 563.163;
								//best.placements[0][j].rotation = 90;

								//best.placements[0][j].x = -447.279;
								//best.placements[0][j].y = 676.803;
								//best.placements[0][j].rotation = 270;

								//best.placements[0][j].x = -587.247;
								//best.placements[0][j].y = -405.284;
								//best.placements[0][j].rotation = 0;

								//best.placements[0][j].x = 1694;
								//best.placements[0][j].y = 824;
								//best.placements[0][j].rotation = 180;
							...
							else if(best.placements[0][j].id == 4)
							{
								//best.placements[0][j].x = -619.962;
								//best.placements[0][j].y = -396.514;
								//best.placements[0][j].rotation = 0;

								//best.placements[0][j].x = 438.721;
								//best.placements[0][j].y = -582.463;
								//best.placements[0][j].rotation = 90;

								//best.placements[0][j].x = -428.024;
								//best.placements[0][j].y = 680.094;
								//best.placements[0][j].rotation = 270;

								//best.placements[0][j].x = 461.374;
								//best.placements[0][j].y = -619.962;
								//best.placements[0][j].rotation = 90;

								//best.placements[0][j].x = 345;
								//best.placements[0][j].y = 2589.68;
								//best.placements[0][j].rotation = 270;

								//best.placements[0][j].x = 100//415
								//best.placements[0][j].y = 100//-691
								//best.placements[0][j].rotation = 0// 90;
							...
							else if(best.placements[0][j].id == 5)
							{
								//best.placements[0][j].x = -630.842;
								//best.placements[0][j].y = -407.254;
								//best.placements[0][j].rotation = 0;

								//best.placements[0][j].x = 465.586;
								//best.placements[0][j].y = -578.662;
								//best.placements[0][j].rotation = 90;

								//best.placements[0][j].x = 649.705;
								//best.placements[0][j].y = 542.655;
								//best.placements[0][j].rotation = 180;

								//best.placements[0][j].x = 493.564;
								//best.placements[0][j].y = -594.029;
								//best.placements[0][j].rotation = 90;

								//best.placements[0][j].x = 749.137;
								//best.placements[0][j].y = 1809;
								//best.placements[0][j].rotation = 270;
							...
							else if(best.placements[0][j].id == 6)
							{
								//best.placements[0][j].x = 488.172;
								//best.placements[0][j].y = -698.600;
								//best.placements[0][j].rotation = 90;

								//best.placements[0][j].x = -746.982;
								//best.placements[0][j].y = -375.995;
								//best.placements[0][j].rotation = 0;

								//best.placements[0][j].x = -735.127;
								//best.placements[0][j].y = -409.798;
								//best.placements[0][j].rotation = 0;

								//best.placements[0][j].x = -386.292;
								//best.placements[0][j].y = 837.349;
								//best.placements[0][j].rotation = 270;



							}
							else if(best.placements[0][j].id == 7)
							{
								//best.placements[0][j].x = -633.310;
								//best.placements[0][j].y = -455.002;
								//best.placements[0][j].rotation = 0;

								//best.placements[0][j].x = -641.303;
								//best.placements[0][j].y = -330.553;
								//best.placements[0][j].rotation = 0;

								//best.placements[0][j].x = -451.617;
								//best.placements[0][j].y = 784.856;
								//best.placements[0][j].rotation = 270;

								//best.placements[0][j].x = -468.421;
								//best.placements[0][j].y = 754.621;
								//best.placements[0][j].rotation = 270;


							}
							else if(best.placements[0][j].id == 8)
							{
								//best.placements[0][j].x = 554.903;
								//best.placements[0][j].y = -479.518;
								//best.placements[0][j].rotation = 90;

								//best.placements[0][j].x = 554.903;
								//best.placements[0][j].y = -487.557;
								//best.placements[0][j].rotation = 90;

								//best.placements[0][j].x = -448.263;
								//best.placements[0][j].y = 701.415;
								//best.placements[0][j].rotation = 270;

								//best.placements[0][j].x = 680.980
								//best.placements[0][j].y = 645.270
								//best.placements[0][j].rotation = 180;



							}
							else if(best.placements[0][j].id == 9)
							{
								//best.placements[0][j].x = 552.251;
								//best.placements[0][j].y = -602.586;
								//best.placements[0][j].rotation = 90;
						
								//best.placements[0][j].x = 808.589;
								//best.placements[0][j].y = 529.300;
								//best.placements[0][j].rotation = 180;

								//best.placements[0][j].x = 547.586;
								//best.placements[0][j].y = -691.930;
								//best.placements[0][j].rotation = 90;

								//best.placements[0][j].x = 529.300;
								//best.placements[0][j].y = -759.315;
								//best.placements[0][j].rotation = 90;


							}
							else if(best.placements[0][j].id == 10)
							{
								//best.placements[0][j].x = 552.251;
								//best.placements[0][j].y = -602.586;
								//best.placements[0][j].rotation = 90;
								...
								//best.placements[0][j].x = -664.255
								//best.placements[0][j].y =-386.730
								//best.placements[0][j].rotation = 270;


							}
							else if(best.placements[0][j].id == 11)
							{
								//best.placements[0][j].x = 552.251;
								//best.placements[0][j].y = -602.586;
								//best.placements[0][j].rotation = 90;
								...
								//best.placements[0][j].x =-501.351
								//best.placements[0][j].y = 763.074
								//best.placements[0][j].rotation = 270;


							}
							else if(best.placements[0][j].id == 12)
							{
								//best.placements[0][j].x = 552.251;
								//best.placements[0][j].y = -602.586;
								//best.placements[0][j].rotation = 90;
							...
							else if(best.placements[0][j].id == 13)
							{
								//best.placements[0][j].x = 552.251;
								//best.placements[0][j].y = -602.586;
								//best.placements[0][j].rotation = 90;
							...
							else if(best.placements[0][j].id == 14)
							{
								//best.placements[0][j].x = 552.251;
								//best.placements[0][j].y = -602.586;
								//best.placements[0][j].rotation = 90;
		...
		this.applyPlacement = function(placement){
			...
			for(i=0; i<placement.length; i++){
				...
				for(j=0; j<placement[i].length; j++){
					...
					//partgroup.setAttribute('transform',' rotate('+p.rotation+') translate('+p.x+' '+p.y+')');

					
					//partgroup.setAttribute('transform1','rotate('+p.rotation+')');
					//partgroup.setAttribute('transform2','translate('+p.x+' '+p.y+')');
					
					//partgroup.setAttribute('transform','rotate('+p.rotation+')');
					//partgroup.setAttribute('transform','translate('+p.x+' '+p.y+')');
					//partgroup.setAttribute('transform','rotate('+p.rotation+')');
	...
	function GeneticAlgorithm(adam, bin, config){
		...
		this.config = config || { populationSize: 10, mutationRate: 10, rotations: 2 };
